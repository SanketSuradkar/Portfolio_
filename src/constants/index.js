...
import {
  // when ever trying to add the new module, it stucks and stop working , so do not try to add any new element for the icons and the languages it is having bugs that it does not response at perticular sizes
